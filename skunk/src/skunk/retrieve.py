...
treasury; override via `SKUNK_CORPUS_PROFILE`).
"""
...
class RetrieveExecutor:
    """Page-index retrieval operator. One instance per orchestrator;
    ...
    Not a `SkunkExecutor` subclass — the only LLM call (the L1 chapter
    ...
    loading, year-window filter, golden-bypass.
    """
