...
Carnot runner implementation for animals use case.
"""
import os
...
class CarnotRunner(GenericCarnotRunner):
    """Carnot runner for animals use case."""
    ...
    def __init__(
        ...
        """
        Initialize Carnot runner for animals case.
    ...
    def _get_empty_results_dataframe(self, query_id: int) -> pd.DataFrame:
        ...
        elif query_id in [3, 4, 5, 6, 7, 8, 9]:
