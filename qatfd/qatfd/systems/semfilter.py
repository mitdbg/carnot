...
of candidate documents down to those actually relevant before reading them. Only
execute it on document sets of <=1,000 documents.

```python
doc_ids = ["doc_id_1", "doc_id_2", ..., "doc_id_n"]
semantic_filter(doc_ids=doc_ids, predicate="discusses topic X in relation to Y")
```"""
