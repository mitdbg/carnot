...
One vector search over the corpus, stuff the top-k chunks into a single LLM call.
No agent loop. retrieve() returns the chunk context (and the chunks' doc_ids for
doc-recall); the default compute() answers from that context.
"""
