...
from datagen.dedup import DedupConfig, dedup_batch
from datagen.quality_filter import (
...
from datagen.task_solver import TaskSolverConfig
from datagen.tinker_cost import resolve_prices, write_run_report
...
from datagen.tinker_backend import (
...
# (see datagen.tinker_backend), so the per-token logprobs captured here
    ...
    try:
        ...
        try:
            ...
            print(
                ...
                f"(aggregate with `python -m datagen.tinker_cost`)."
            )
        except Exception as e:
